...
func Generate3x4Canvas() Canvas {
	...
	canvasPoints := PointArray{}
	canvasPoints.Points = []Point{point0, point1, point2, point3, point4, point5, point6, point7, point8, point9}
	canvas := Canvas{
		Points: canvasPoints,
	}
	return canvas
...
func Generate1x1() Shape {
	...
	canvasPoints := PointArray{}
	canvasPoints.Points = []Point{point0}
	canvas := Shape{
		Rotations: GenerateRotations(canvasPoints),
	}
	return canvas
